    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <h2>Editar Pedido de Assistência Técnica {{$pat->id}}</h2>


          <div class="ibox-content">
            <form method="POST" class="form-horizontal" action="/pats/{{$pat->id}}">
              {{method_field('PATCH')}}
              <div class="form-group"><label class="col-sm-2 control-label">P.A.T:</label>

                <div class="col-sm-10"><input type="text" name="id" class="form-control" value="P.A.T: {{$pat->id}}" readonly></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  {!! Form::select('idequipamento', $items, $pat->idequipamento, ['class' => 'form-control m-b']) !!}
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class='input-group date' id='datepicker1'>
                    ...
                    <input type='date' name="data" class="form-control" value="{{$pat->data}}"/>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  {!! Form::select('status_id', $items2, $pat->status_id, ['class' => 'form-control m-b']) !!}
                </div>
              </div>

              <div class="form-group"><label class="col-sm-2 control-label">Descrição da Avaria:</label>

                <div class="col-sm-10"><textarea style="resize:vertical" maxlength="255" name="descricaoAvaria" class="form-control" value="">{{$pat->descricaoAvaria}}</textarea></div>

              </div>

              <div class="form-group"><label class="col-sm-2 control-label">Notas:</label>

                <div class="col-sm-10"><textarea style="resize:vertical" maxlength="255" name="notas" class="form-control" value="">{{$pat->notas}}</textarea></div>

              </div>
              <div class="form-group"><label class="col-sm-2 control-label">Descrição da Reparação:</label>

                <div class="col-sm-10"><textarea style="resize:vertical" maxlength="255" name="descricaoReparacao" class="form-control"  value="">{{$pat->descricaoReparacao}}</textarea></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class='input-group date' id='datepicker2'>
                    ...
                    <input type='date' name="dataConclusao" class="form-control" value="{{$pat->dataConclusao}}"/>
                  </div>
                </div>
              </div>
