    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <h2>Editar Pedido de Assistência Técnica ao Fornecedor Nº {{$patf->id}}</h2>

          <div class="ibox-content">
            <form method="POST" class="form-horizontal" action="/patsf/{{$patf->id}}">
              {{method_field('PATCH')}}

              <div class="form-group">


                <!--TODO pat_id nao esta atribuido-->


                {!! Form::Label('pat', 'P.A.T:', array('class'=> 'col-sm-2 control-label')) !!}
                <div class="col-sm-10">
                  {!! Form::select('pat_id', $items, $patf->pat_id, ['class' => 'form-control m-b']) !!}
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  {!! Form::select('idFornecedor', $items2, $patf->idFornecedor, ['class' => 'form-control m-b']) !!}
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class='input-group date' id='datepicker1'>
                    ...
                    <input type='date' name="dataEnvioFornecedor" class="form-control"  value="{{$patf->dataEnvioFornecedor}}"/>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class='input-group date' id='datepicker2'>
                    ...
                    <input type='date' name="dataRecepcao" class="form-control" value="{{$patf->dataRecepcao}}"/>
                  </div>
                </div>
              </div>
              {!! Form::Label('file', 'Anexo:', array('class'=> 'col-sm-2 control-label')) !!}

              {!! Form::file('file', null, $patf->docEnvioPath, ['class' => 'form-control m-b']) !!}
