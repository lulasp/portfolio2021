            ...
            <div class="col-lg-12">
              <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                  <div class="">
                    <a href="/equipamentos/create" class="btn btn-primary">Adicionar Equipamento  <i class="fa fa-plus"></i></a>
                  </div>
                  <hr>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="editable" >
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="/equipamentos/{{$equipamento->id}}/destroy" onclick="return confirm('Apagar o equipamento {{$equipamento->nserie}} ?');"><i class="fa fa-trash text-navy"></i></a></td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
